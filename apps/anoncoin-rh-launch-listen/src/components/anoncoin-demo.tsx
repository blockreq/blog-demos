...
import { isAddr, shortAddr, unpadTopic, wordAddr, wordU256 } from "@/lib/utils";

/** Robinhood Chain · public Free path (chainId 0x1237). */
    ...
    <div className="space-y-6">
      <header className="space-y-3">
        ...
        <p className="text-base text-slate-600 sm:text-lg">
          Auto-starts on load. Listens for new launches on Robinhood Chain via BlockReq
          public WSS using <code className="rounded bg-slate-100 px-1.5 py-0.5 text-[0.95em]">eth_subscribe</code>{" "}
          logs (no aggressive polling).
        </p>
